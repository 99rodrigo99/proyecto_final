  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="agregar_roles" method="POST" class="row g-3 needs-validation" novalidate>
                <div class="col-md-12">
      ...
      <table class="table">
        ...
        <tbody>
          <?php
          foreach ($datos_roles as $rl) {
          ?>
            <tr>
              <th scope="row"><?php echo $rl->id ?></th>
              <td><?php echo $rl->roles ?></td>
            </tr>
